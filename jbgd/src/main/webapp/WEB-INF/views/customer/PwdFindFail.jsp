...
<div id="wholeDiv">
	...
	<div id="wholePwdFindFailDiv">
	
		<div id="pwdFindFailTitleDiv">
			<p id="pwdFindFailTitleP">비밀번호 찾기 실패</p>
		</div>
		
		<div id="pwdFindFailContentDiv">
			회원정보가 존재하지 않습니다
		</div>
		
		<div id="pwdFindFailBtnDiv">
			<div>
				<span>
					<input type="button" value="뒤로가기" class="btn"
						id="goToPwdFindBtn" onclick="pageMovePwdFindFnc();">
				</span>
			</div>
			<div>
				<span>
